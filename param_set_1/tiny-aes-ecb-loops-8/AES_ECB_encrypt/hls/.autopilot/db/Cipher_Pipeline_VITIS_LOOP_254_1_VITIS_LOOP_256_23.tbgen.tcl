set moduleName Cipher_Pipeline_VITIS_LOOP_254_1_VITIS_LOOP_256_23
set isTopModule 0
...
set C_modelName {Cipher_Pipeline_VITIS_LOOP_254_1_VITIS_LOOP_256_23}
...
set C_modelArgList {
	...
	{ sbox int 8 regular {array 256 { 1 } 1 1 } {global 0}  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ sbox_address0 sc_out sc_lv 8 signal 1 } 
	{ sbox_ce0 sc_out sc_logic 1 signal 1 } 
	{ sbox_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 4 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_we0 mem_we 1 1 }  { buf_r_d0 mem_din 1 8 }  { buf_r_address1 MemPortADDR2 1 4 }  { buf_r_ce1 MemPortCE2 1 1 }  { buf_r_q1 MemPortDOUT2 0 8 } } }
	sbox { ap_memory {  { sbox_address0 mem_address 1 8 }  { sbox_ce0 mem_ce 1 1 }  { sbox_q0 mem_dout 0 8 } } }
}
