# 1 "../../tiny-AES-c-mod/aes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 339 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 263 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 2 "<built-in>" 2
# 1 "../../tiny-AES-c-mod/aes.c" 2
# 38 "../../tiny-AES-c-mod/aes.c"
...
# 1 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 1 3 4
# 62 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 39 "../../tiny-AES-c-mod/aes.c" 2
# 1 "../../tiny-AES-c-mod/aes.h" 1



# 1 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 1 3
# 63 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 3
...
# 64 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 2 3
# 5 "../../tiny-AES-c-mod/aes.h" 2
# 1 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 1 3
# 51 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3
typedef long int ptrdiff_t;
# 90 "/home/ctf/research/Xilinx/Vitis_HLS/2024.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3
typedef int wchar_t;
# 6 "../../tiny-AES-c-mod/aes.h" 2
# 44 "../../tiny-AES-c-mod/aes.h"
struct AES_ctx
{
...
__attribute__((sdx_kernel("AES_ECB_encrypt", 0))) void AES_ECB_encrypt(const struct AES_ctx* ctx, uint8_t buf[4][4]);
void AES_ECB_decrypt(const struct AES_ctx* ctx, uint8_t buf[4][4]);
# 73 "../../tiny-AES-c-mod/aes.h"
void AES_CBC_encrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, size_t length);
void AES_CBC_decrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, size_t length);
# 86 "../../tiny-AES-c-mod/aes.h"
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, size_t length);
# 40 "../../tiny-AES-c-mod/aes.c" 2
# 72 "../../tiny-AES-c-mod/aes.c"
...
static void KeyExpansion(uint8_t* RoundKey, const uint8_t* Key)
{
  ...
  VITIS_LOOP_152_1: for (i = 0; i < 4; ++i)
  {
  ...
  VITIS_LOOP_161_2: for (i = 4; i < 4 * (10 + 1); ++i)
  {
    {
      k = (i - 1) * 4;
...
{
  uint8_t i,j;
  VITIS_LOOP_240_1: for (i = 0; i < 4; ++i)
  {
    VITIS_LOOP_242_2: for (j = 0; j < 4; ++j)
    {
...
{
  uint8_t i, j;
  VITIS_LOOP_254_1: for (i = 0; i < 4; ++i)
  {
    VITIS_LOOP_256_2: for (j = 0; j < 4; ++j)
    {
...
static void MixColumns(uint8_t state[4][4])
{
  uint8_t i;
  uint8_t Tmp, Tm, t;
  VITIS_LOOP_304_1: for (i = 0; i < 4; ++i)
  {
    t = state[i][0];
...
# 350 "../../tiny-AES-c-mod/aes.c"
static void InvMixColumns(uint8_t state[4][4])
{
  int i;
  uint8_t a, b, c, d;
  VITIS_LOOP_354_1: for (i = 0; i < 4; ++i)
  {
    a = state[i][0];
    b = state[i][1];
    c = state[i][2];
...
{
  uint8_t i, j;
  VITIS_LOOP_374_1: for (i = 0; i < 4; ++i)
  {
    VITIS_LOOP_376_2: for (j = 0; j < 4; ++j)
    {
...
static void Cipher(uint8_t state[4][4], const uint8_t* RoundKey)
{
  ...
  VITIS_LOOP_424_1: for (round = 1; ; ++round)
  {
    SubBytes(state);
    ShiftRows(state);
    if (round == 10) {
...
static void InvCipher(uint8_t state[4][4], const uint8_t* RoundKey)
{
  ...
  VITIS_LOOP_450_1: for (round = (10 - 1); ; --round)
  {
    InvShiftRows(state);
    InvSubBytes(state);
    AddRoundKey(round, state, RoundKey);
...
# 470 "../../tiny-AES-c-mod/aes.c"
__attribute__((sdx_kernel("AES_ECB_encrypt", 0))) void AES_ECB_encrypt(const struct AES_ctx* ctx, uint8_t buf[4][4])
{
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=AES_ECB_encrypt
# 471 "../../tiny-AES-c-mod/aes.c"
...
# 492 "../../tiny-AES-c-mod/aes.c"
static void XorWithIv(uint8_t* buf, const uint8_t* Iv)
{
  uint8_t i;
  VITIS_LOOP_495_1: for (i = 0; i < 16; ++i)
  {
    buf[i] ^= Iv[i];
  }
}
...
void AES_CBC_encrypt_buffer(struct AES_ctx *ctx, uint8_t* buf, size_t length)
{
  size_t i;
  uint8_t *Iv = ctx->Iv;
  VITIS_LOOP_505_1: for (i = 0; i < length; i += 16)
  {
    XorWithIv(buf, Iv);
...
void AES_CBC_decrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, size_t length)
{
  ...
  VITIS_LOOP_520_1: for (i = 0; i < length; i += 16)
  {
...
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, size_t length)
{
  ...
  size_t i;
  int bi;
  VITIS_LOOP_544_1: for (i = 0, bi = 16; i < length; ++i, ++bi)
  {
    if (bi == 16)
    {

      memcpy(buffer, ctx->Iv, 16);
      Cipher((uint8_t (*)[4])buffer,ctx->RoundKey);


      VITIS_LOOP_553_2: for (bi = (16 - 1); bi >= 0; --bi)
      {
