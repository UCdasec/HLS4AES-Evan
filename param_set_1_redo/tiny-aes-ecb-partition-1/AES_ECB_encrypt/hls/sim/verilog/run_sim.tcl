...
if {[file isfile AES_ECB_encrypt.autotvin.dat]} {
	file delete -force AES_ECB_encrypt.autotvin.dat
}

if {[file isfile AES_ECB_encrypt.autotvout.dat]} {
	file delete -force AES_ECB_encrypt.autotvout.dat
}
